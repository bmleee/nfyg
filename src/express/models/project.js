		...
		switch (type) {
			...
			case 'project_detail':
				...
				return {
			        ...
			        "message": "본격 '목욕'문화 잡지라.... 안에 내용부터, 공연까지 심상치 않은 프로젝트입니다- 본격 '목욕'문화 잡지라.... 안에 내용부터, 공연까지 심상치 않은 프로젝트입니다- 본격 '목욕'문화 잡지라.... 안에 내용부터, 공연까지 심상치 않은 프로젝트입니다- 본격 '목욕'문화 잡지라.... 안에 내용부터, 공연까지 심상치 않은 프로젝트입니다-",
			        "likes": 1,
			        "comments": 20,
			        "shares": 3,
			        "rank": 2
