...
export default class PurchaseShippingList extends Component {
  render() {
    const {
    ...
    var preparing_purchase_num = new Array;
		for(var i in purchases) {
		  if(purchases[i].purchase_info.purchase_state == "shipping" ) {
    ...
    return (
      <div className="purcahse-list-container">
        <h4 className="purcahse-list-title">발송 완료 내역</h4>
        {
