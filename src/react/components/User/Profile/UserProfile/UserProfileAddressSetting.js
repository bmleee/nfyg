			...
			<div className="purchase-reward-container">
				<div className="purchase-stage-content-container">
					...
					<div className="profile-setting-addressee_name-container">
						<input className="profile-setting-addressee_name" type="text" id="addressee_name" placeholder="받는 분 성함" />
					</div>
					<div className="profile-setting-addressee_number-container">
						<input className="profile-setting-addressee_number" type="text" id="addressee_number" placeholder="받는 분 연락처" />
					</div>
