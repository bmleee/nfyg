    ...
    return (
      <div>
        ...
        <Link to={item.sliderlink}>
            <div className='store-slide-info'>
              <div className='store-slide-subject'>{item.subject}</div>
              <div className='store-slide-title'>{item.title}</div>
              <div className='store-slide-description'>{item.description}</div>
            </div>
            <span className='image-gallery-description'>
              <div><h5>{item.subject}</h5></div>
              {item.title}
