...
class Badge extends Component {
	...
	render() {
		...
		return (
			<div className="home">
				<MetaTags>
		            <title>뱃지 - 7Pictures | 세븐픽쳐스</title>
		        </MetaTags>
				...
				<div className="category-head">
					<div className="category-head-title" onClick={ () => this.category_close() }>뱃지</div>
				...
				:
				<div className="category-head">
					<div className="category-head-title" onClick={ () => this.category_open() }>뱃지</div>
