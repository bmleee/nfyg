...
class green extends Component {
	...
	render() {
		...
		return (
			<div className="home">
				<MetaTags>
		            <title>그린디자인 - 7Pictures | 세븐픽쳐스</title>
		        </MetaTags>
				...
				<div className="category-head">
					<div className="category-head-title" onClick={ () => this.category_close() }>그린디자인</div>
				...
				:
				<div className="category-head">
					<div className="category-head-title" onClick={ () => this.category_open() }>그린디자인</div>
