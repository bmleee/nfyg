...
class Mobilefooter extends Component {
	...
	onClickContact = () => {
		...
		let text = document.getElementById('contact-text-mobile').value
        	...
        	<div className="footer-mobile-contact">
				...
				<Modal className="project-suggest-modal" visible={this.state.visible} width="480" height="400" effect="fadeInDown" onClickAway={() => this.closeModal()}>
					...
					<div className="contact-content">문의 내용
						<textarea className="contact-content-textarea" type="textarea" id="contact-text-mobile" value={this.state.textarea} onChange={e => this.setState({ textarea : e.target.value })}/>
					</div>
					</div>
